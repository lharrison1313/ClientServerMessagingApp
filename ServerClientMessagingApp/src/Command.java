...
public class Command implements java.io.Serializable {
    ...
    private SealedObject command, sender, recipient,option;

    //command object consist of a command, an option for that command, a sender and a recipient
    public Command(SealedObject command, SealedObject option, SealedObject sender, SealedObject recipient) {
